...
- **Status:** ready_for_release (5.2.12 library-index wipe hotfix)
- Default version is `5.2.12`; tag `v5.2.12` triggers GitHub Actions to publish installer and portable ZIP. AppId and per-user upgrade remain unchanged.
