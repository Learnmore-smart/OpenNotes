...
- **Status:** ready_for_release (5.2.11 interaction/Fluent refresh)
- Default version is `5.2.11`; tag `v5.2.11` triggers GitHub Actions to publish installer and portable ZIP. AppId and per-user upgrade remain unchanged.
