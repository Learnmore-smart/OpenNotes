...
- **Status:** complete (5.1.0 release metadata)
- Project, assembly, file and informational versions are aligned to `5.1.0`; the verified startup fix and all compatibility identities remain unchanged.
- **Status:** complete
