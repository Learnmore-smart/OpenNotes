...
- **Verification:** helper invocation returns `PdfPageControl.0`, `TextResizeHandle.BottomRight`, `TextAnnotationDragHandle` and `PdfScrollViewer`; parser and source contracts are green.
