...
- v5.2.13 adds `Home.DocumentFilter`, `Home.OpenDocumentTitle`, `Home.ConvertingWord`, `Home.WordConverterMissing`, and `Home.WordConvertFailed` with EN/ZH/FR placeholder parity.
