...
| 2026-08-24 | Normalized the floating toolbar on the existing Lucide renderer, added localized custom WPF ToolTips, removed the sidebar right-edge/resize rail, and expanded the checkmark-free shape picker to 3×3. | Codex |
