# OpenNotes.csproj
> 2026-09-06 RELEASED: package/assembly/file/informational metadata are 5.2.12/5.2.12.0 for the library-index wipe hotfix; `RootNamespace=Caelum`, self-contained win-x64 settings, and all compatibility identities remain unchanged.
