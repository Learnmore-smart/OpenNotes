# OpenNotes.csproj
> 2026-09-05 RELEASED: package/assembly/file/informational metadata are 5.2.11/5.2.11.0; `RootNamespace=Caelum`, self-contained win-x64 settings, and all compatibility identities remain unchanged.
