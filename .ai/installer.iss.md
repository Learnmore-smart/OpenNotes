# installer.iss
> 2026-09-06 GREEN: default installer version is 5.2.12 for the library-index wipe hotfix; AppId, per-user semantics, and upgrade compatibility remain preserved.
