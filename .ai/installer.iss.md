# installer.iss
> 2026-09-05 GREEN: default installer version is 5.2.11 for the interaction/Fluent refresh; AppId, per-user semantics, and upgrade compatibility remain preserved.
