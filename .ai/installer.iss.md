# installer.iss
> 2026-09-08 GREEN: default installer version is 5.2.14 for the tab-close-after-inking hotfix; AppId, per-user semantics, and upgrade compatibility remain preserved.
...
- Default version is `5.2.8`; AppId and per-user upgrade behavior remain unchanged.
