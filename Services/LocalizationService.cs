...
namespace Caelum.Services
{
    public static class LocalizationService
    {
        ...
        private static readonly Dictionary<string, (string English, string Chinese, string French)> Strings = new()
        {
            ...
            ["Editor.Action.Copy"] = ("Copy", "复制", "Copier"),
            ["Editor.Action.Paste"] = ("Paste", "粘贴", "Coller"),
            ["Editor.Action.Delete"] = ("Delete", "删除", "Supprimer"),
            ["Editor.Action.SelectAll"] = ("Select all", "全选", "Tout sélectionner"),
            ["Editor.Action.RefreshPage"] = ("Refresh page", "刷新页面", "Actualiser la page"),
            ...
            ["Home.Context.Color"] = ("Folder color", "\u6587\u4EF6\u5939\u989C\u8272", "Couleur du dossier"),
            ["Home.FolderColor.Amber"] = ("Amber", "琥珀", "Ambre"),
            ["Home.FolderColor.Red"] = ("Red", "红", "Rouge"),
            ["Home.FolderColor.Orange"] = ("Orange", "橙", "Orange"),
            ["Home.FolderColor.Green"] = ("Green", "绿", "Vert"),
            ["Home.FolderColor.Blue"] = ("Blue", "蓝", "Bleu"),
            ["Home.FolderColor.Purple"] = ("Purple", "紫", "Violet"),
            ["Home.FolderColor.Pink"] = ("Pink", "粉", "Rose"),
            ["Home.FolderColor.Slate"] = ("Slate", "灰蓝", "Ardoise"),
            ["Home.Context.Delete"] = ("Delete file", "\u5220\u9664\u6587\u4EF6", "Supprimer le fichier"),
            ...
            ["Home.DeleteTitle"] = ("Delete this file?", "删除这个文件？", "Supprimer ce fichier ?"),
            ["Home.DeleteMessage"] = ("\"{0}\" will be moved to the Recycle Bin. You can restore it from there.", "“{0}”将移到回收站，之后仍可从回收站还原。", "« {0} » sera déplacé vers la Corbeille. Vous pourrez le restaurer ensuite."),
            ...
            ["Home.OpenDocumentTitle"] = ("Open PDF or Word file", "打开 PDF 或 Word 文件", "Ouvrir un PDF ou un fichier Word"),
            ...
            ["Home.DocumentFilter"] = ("PDF and Word files|*.pdf;*.doc;*.docx;*.docm|PDF files (*.pdf)|*.pdf|Word documents (*.doc;*.docx;*.docm)|*.doc;*.docx;*.docm", "PDF 和 Word 文件|*.pdf;*.doc;*.docx;*.docm|PDF 文件 (*.pdf)|*.pdf|Word 文档 (*.doc;*.docx;*.docm)|*.doc;*.docx;*.docm", "Fichiers PDF et Word|*.pdf;*.doc;*.docx;*.docm|Fichiers PDF (*.pdf)|*.pdf|Documents Word (*.doc;*.docx;*.docm)|*.doc;*.docx;*.docm"),
            ["Home.ConvertingWord"] = ("Converting Word document…", "正在将 Word 转换为 PDF…", "Conversion du document Word…"),
            ["Home.WordConverterMissing"] = ("Install Microsoft Word or LibreOffice to import Word documents.", "导入 Word 需要安装 Microsoft Word 或 LibreOffice。", "Installez Microsoft Word ou LibreOffice pour importer des documents Word."),
            ...
            ["Home.Selection.MoveHint"] = ("Click a folder on this screen to move the selected files.", "点击屏幕上的文件夹以移动所选文件。", "Cliquez sur un dossier à l'écran pour y déplacer les fichiers sélectionnés."),
            ["Home.Selection.Remove"] = ("Remove from library", "从库中移除", "Retirer de la bibliothèque"),
            ["Home.Selection.Delete"] = ("Delete files", "删除文件", "Supprimer les fichiers"),
            ["Home.Selection.DeleteTitle"] = ("Delete files?", "删除这些文件？", "Supprimer ces fichiers ?"),
            ["Home.Selection.DeleteMessage"] = ("{0} file(s) will be moved to the Recycle Bin. You can restore them from there.", "{0} 个文件将移到回收站，之后仍可从回收站还原。", "{0} fichier(s) seront déplacés vers la Corbeille. Vous pourrez les restaurer ensuite."),
            ["Home.Selection.DeletedCount"] = ("Deleted {0} file(s).", "已删除 {0} 个文件。", "{0} fichier(s) supprimé(s)."),
            ...
            ["Home.Subtitle"] = ("Open a PDF or Word file, create a notebook, or organize your library.", "打开 PDF 或 Word、创建笔记本，或整理你的库。", "Ouvrez un PDF ou un fichier Word, créez un carnet ou organisez votre bibliothèque."),
            ...
            ["Main.UpdateCheckFailedNetwork"] = ("Couldn't reach GitHub. Check your internet connection and try again.", "\u65E0\u6CD5\u8FDE\u63A5\u5230 GitHub\u3002\u8BF7\u68C0\u67E5\u7F51\u7EDC\u8FDE\u63A5\u540E\u91CD\u8BD5\u3002", "Impossible de joindre GitHub. V\u00E9rifiez votre connexion Internet et r\u00E9essayez."),
            ["Main.UpdateCheckFailedTimeout"] = ("The update check timed out. Try again in a moment.", "\u68C0\u67E5\u66F4\u65B0\u8D85\u65F6\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5\u3002", "La recherche de mises \u00E0 jour a expir\u00E9. R\u00E9essayez dans un instant."),
            ["Main.UpdateCheckFailedHttp"] = ("GitHub returned an unexpected response. Try again later.", "GitHub \u8FD4\u56DE\u4E86\u5F02\u5E38\u54CD\u5E94\uFF0C\u8BF7\u7A0D\u540E\u518D\u8BD5\u3002", "GitHub a renvoy\u00E9 une r\u00E9ponse inattendue. R\u00E9essayez plus tard."),
            ["Main.UpdateCheckFailedInvalid"] = ("The update information from GitHub was not trusted. Try again later.", "\u6765\u81EA GitHub \u7684\u66F4\u65B0\u4FE1\u606F\u672A\u901A\u8FC7\u6821\u9A8C\uFF0C\u8BF7\u7A0D\u540E\u518D\u8BD5\u3002", "Les informations de mise \u00E0 jour GitHub n'ont pas pu \u00EAtre v\u00E9rifi\u00E9es. R\u00E9essayez plus tard."),
