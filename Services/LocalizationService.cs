...
namespace Caelum.Services
{
    public static class LocalizationService
    {
        ...
        private static readonly Dictionary<string, (string English, string Chinese, string French)> Strings = new()
        {
            ...
            ["Editor.ShapeDashedLine"] = ("Dashed line", "\u865A\u7EBF", "Ligne pointill\u00E9e"),
            ...
            ["Main.UpToDateMessage"] = ("You're using the latest version ({0}).", "\u5F53\u524D\u5DF2\u662F\u6700\u65B0\u7248\u672C\uFF08{0}\uFF09\u3002", "Vous utilisez la derni\u00E8re version ({0})."),
            ["Main.UpToDateTitle"] = ("You're up to date", "\u5DF2\u662F\u6700\u65B0\u7248\u672C", "OpenNotes est \u00E0 jour"),
            ["Main.UpdateAvailableMessage"] = ("Version {1} is available. You are using {0}.", "\u65B0\u7248\u672C {1} \u53EF\u7528\u3002\u5F53\u524D\u7248\u672C\uFF1A{0}\u3002", "La version {1} est disponible. Vous utilisez la version {0}."),
            ["Main.UpdateAvailableTitle"] = ("Update available", "\u6709\u53EF\u7528\u66F4\u65B0", "Mise \u00E0 jour disponible"),
            ["Main.UpdateCheckFailedMessage"] = ("Check your internet connection and try again.", "\u8BF7\u68C0\u67E5\u7F51\u7EDC\u8FDE\u63A5\u540E\u91CD\u8BD5\u3002", "V\u00E9rifiez votre connexion Internet et r\u00E9essayez."),
            ["Main.UpdateCheckFailedTitle"] = ("Couldn't check for updates", "\u65E0\u6CD5\u68C0\u67E5\u66F4\u65B0", "Impossible de rechercher les mises \u00E0 jour"),
